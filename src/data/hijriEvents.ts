...
export const HIJRI_EVENTS: HijriEvent[] = [
  ...
  },
  {
    ...
    descriptionAr: 'يُحيي كثير من المسلمين الثاني عشر من ربيع الأول ذكرى مولد سيد الخلق النبي محمد ﷺ عام 571م بمكة المكرمة في عام الفيل. وُلد ﷺ يتيم الأب وتوفيت أمه وهو في السادسة، فكفله جده عبد المطلب ثم عمه أبو طالب. بُعث رسولًا في سن الأربعين وأتمّ الله به نور الإسلام. ويُحتفى بهذه الذكرى بقراءة سيرته ﷺ والإكثار من الصلاة والسلام عليه.\n\nاختلف العلماء المتقدّمون والمتأخّرون في إحياء هذه الذكرى: فمنهم من استحسنها وأجازها بتلاوة السيرة النبوية وإطعام الطعام والشكر لله على نعمة ولادة النبي ﷺ، وعدّوها أمرًا مستحبًّا ما دامت خالية من المخالفات الشرعية والمنكرات، ومنهم: الحافظ ابن حجر العسقلاني (شارح صحيح البخاري)، والإمام جلال الدين السيوطي (وله رسالة بعنوان «حُسن المقصد في عمل المولد»)، والإمام ابن كثير (صاحب التفسير والتاريخ)، ودور الإفتاء المعاصرة كدار الإفتاء المصرية والمجالس الفقهية في بلاد الشام والمغرب العربي.\n\nومنهم من منعها ورأى أن الاحتفال بها أو تخصيصها بعبادة أو تجمّع بدعةٌ محدثة في الدين؛ لأن النبي ﷺ لم يفعله، ولم يفعله الخلفاء الراشدون ولا الصحابة ولا التابعون في القرون المفضّلة، ومنهم: شيخ الإسلام ابن تيمية، والشيخ عبد العزيز بن باز، والشيخ محمد بن صالح العثيمين، والشيخ صالح الفوزان.',
    descriptionEn: "Many Muslims observe the 12th of Rabīʿ al-Awwal as the birth anniversary of Prophet Muhammad ﷺ, born in Makkah around 570 CE in the Year of the Elephant. He was orphaned early and raised by his grandfather and uncle. At 40, he received revelation and spent 23 years guiding humanity. Observances often include reading his biography (Seerah), sending blessings upon him, and gathering for learning.\n\nScholars, both early and later, have differed over commemorating this occasion. Some permitted and even encouraged it — through reciting the Prophet's biography, feeding people, and giving thanks to Allah for the blessing of his birth ﷺ — viewing it as recommended so long as it is free of religious violations. Among them: al-Ḥāfiẓ Ibn Ḥajar al-ʿAsqalānī (commentator on Ṣaḥīḥ al-Bukhārī), Imam Jalāl al-Dīn al-Suyūṭī (who authored a treatise on the subject), Imam Ibn Kathīr (the exegete and historian), and contemporary fatwa bodies such as the Egyptian Dār al-Iftāʾ.\n\nOthers forbade it, holding that celebrating it or singling out this night with worship or gatherings is an innovation (bidʿah) in the religion — since the Prophet ﷺ did not do so, nor did the Rightly-Guided Caliphs, the Companions, or their followers in the best generations. Among them: Shaykh al-Islām Ibn Taymiyyah, Shaykh ʿAbd al-ʿAzīz ibn Bāz, Shaykh Muhammad ibn Sālih al-ʿUthaymīn, and Shaykh Sālih al-Fawzān.",
  },
  {
    month: 7, day: 27,
    ...
    descriptionAr: 'في هذه الليلة المباركة من رجب أُسري بالنبي ﷺ جسدًا وروحًا من المسجد الحرام بمكة إلى المسجد الأقصى بالقدس (الإسراء)، ثم عُرج به إلى السماوات العُلى حتى سدرة المنتهى (المعراج). رأى فيها ما رأى من آيات ربه، وفُرضت عليه وعلى أمته الصلوات الخمس. قال الله تعالى: ﴿سُبْحَانَ الَّذِي أَسْرَىٰ بِعَبْدِهِ لَيْلًا مِنَ الْمَسْجِدِ الْحَرَامِ إِلَى الْمَسْجِدِ الْأَقْصَى﴾.\n\nيرى كبار علماء السلفية — مثل الشيخ عبد العزيز بن باز والشيخ محمد بن صالح العثيمين — أنه لا يوجد نصٌّ صريح في القرآن أو السنة، ولا عن الصحابة أو التابعين، يشرّع إحياء هذه الليلة، ويعدّون الاحتفال بها أو تخصيصها بعبادة معينة من البِدَع المُحدَثة؛ ولو ثبت تعيينها لم يجز تخصيصها بشيء من العبادات ولا الاحتفال بها، لأن النبي ﷺ وأصحابه لم يحتفلوا بها ولم يخصّوها بشيء.',
    descriptionEn: "On this blessed night the Prophet ﷺ was taken from the Sacred Mosque in Makkah to al-Masjid al-Aqsa in Jerusalem (the Night Journey / Isra'), then ascended through the heavens to the Lote Tree (Mi'raj). He was shown the greatest signs of his Lord, and the five daily prayers were made obligatory. Allah says: 'Glory be to the One Who took His servant by night from al-Masjid al-Haram to al-Masjid al-Aqsa.' (Quran 17:1)\n\nSenior Salafi scholars — such as Shaykh ʿAbd al-ʿAzīz ibn Bāz and Shaykh Muhammad ibn Sālih al-ʿUthaymīn — hold that there is no explicit text in the Quran or the Sunnah, nor from the Companions or their followers, that legislates singling out this night; they consider celebrating it or designating it with specific acts of worship to be an innovation (bidʿah). Even if its exact date were established, it would not be permissible to single it out with worship or to celebrate it, since the Prophet ﷺ and his Companions did not do so.",
  },
  {
    month: 9, day: 1,
