...
export const JUZ_DATA_QALOON: JuzInfo[] = [
  ...
  { number: 4,  nameAr: 'لن تنالوا البر',          nameEn: 'Lan Tanaalu al-Birr',     startSurah: 3,  startAyah: 92  },
  { number: 5,  nameAr: 'والمحصنات',              nameEn: 'Wal-Muhsanat',            startSurah: 4,  startAyah: 24  },
  { number: 6,  nameAr: 'لا يحب الله',             nameEn: 'La Yuhibb Allah',         startSurah: 4,  startAyah: 148 },
  { number: 7,  nameAr: 'وإذا سمعوا',             nameEn: 'Wa Iza Samiu',            startSurah: 5,  startAyah: 82  },
  ...
  { number: 11, nameAr: 'يعتذرون',               nameEn: "Ya'tazerun",              startSurah: 9,  startAyah: 93  },
  { number: 12, nameAr: 'وما من دابة',             nameEn: 'Wa Ma Min Dabbah',        startSurah: 11, startAyah: 6   },
  { number: 13, nameAr: 'وما أبرئ نفسي',          nameEn: 'Wa Ma Ubari Nafsi',       startSurah: 12, startAyah: 53  },
  { number: 14, nameAr: 'ربما',                   nameEn: 'Rubama',                  startSurah: 15, startAyah: 1   },
  ...
  { number: 20, nameAr: 'أمن خلق',               nameEn: 'Amman Khalaqa',           startSurah: 27, startAyah: 60  },
  { number: 21, nameAr: 'اتل ما أوحي',            nameEn: 'Utlu Ma Uhiya',           startSurah: 29, startAyah: 45  },
  { number: 22, nameAr: 'ومن يقنت',              nameEn: 'Wa Man Yaqnut',           startSurah: 33, startAyah: 31  },
  { number: 23, nameAr: 'وما لي',                nameEn: 'Wa Mali',                 startSurah: 36, startAyah: 22  },
  ...
  { number: 30, nameAr: 'عمّ',                   nameEn: "'Amma",                   startSurah: 78, startAyah: 1   },
];

export const JUZ_DATA_HAFS: JuzInfo[] = [
  { number: 1,  nameAr: 'الفاتحة',                nameEn: 'Al-Fatihah',              startSurah: 1,  startAyah: 1   },
  { number: 2,  nameAr: 'سيقول السفهاء',           nameEn: 'Sayaqul al-Sufaha',       startSurah: 2,  startAyah: 142 },
  { number: 3,  nameAr: 'تلك الرسل',              nameEn: 'Tilka ar-Rusul',          startSurah: 2,  startAyah: 253 },
  { number: 4,  nameAr: 'لن تنالوا البر',          nameEn: 'Lan Tanaalu al-Birr',     startSurah: 3,  startAyah: 92  },
  { number: 5,  nameAr: 'والمحصنات',              nameEn: 'Wal-Muhsanat',            startSurah: 4,  startAyah: 24  },
  { number: 6,  nameAr: 'لا يحب الله',             nameEn: 'La Yuhibb Allah',         startSurah: 4,  startAyah: 148 },
  { number: 7,  nameAr: 'لتجدن أشد الناس',         nameEn: 'La Tajidanna Ashadda',    startSurah: 5,  startAyah: 82  },
  { number: 8,  nameAr: 'ولو أننا نزلنا',          nameEn: 'Wa Law Annana Nazzalna',  startSurah: 6,  startAyah: 111 },
  { number: 9,  nameAr: 'قال الملأ',              nameEn: 'Qala al-Mala',            startSurah: 7,  startAyah: 88  },
  { number: 10, nameAr: 'واعلموا أنما غنمتم',      nameEn: "Wa'lamu Annama Ghanimtum", startSurah: 8, startAyah: 41  },
  { number: 11, nameAr: 'يعتذرون إليكم',          nameEn: "Ya'taziruna Ilaykum",     startSurah: 9,  startAyah: 92  },
  { number: 12, nameAr: 'وما من دابة',             nameEn: 'Wa Ma Min Dabbah',        startSurah: 11, startAyah: 6   },
  ...
  { number: 16, nameAr: 'قال ألم أقل',             nameEn: 'Qala Alam Aqul',          startSurah: 18, startAyah: 75  },
  { number: 17, nameAr: 'اقترب للناس',            nameEn: 'Iqtaraba lil-Nas',        startSurah: 21, startAyah: 1   },
  { number: 18, nameAr: 'قد أفلح',               nameEn: 'Qad Aflaha',              startSurah: 23, startAyah: 1   },
  { number: 19, nameAr: 'وقال الذين',             nameEn: 'Wa Qala alladhin',        startSurah: 25, startAyah: 21  },
  { number: 20, nameAr: 'أمن خلق',               nameEn: 'Amman Khalaqa',           startSurah: 27, startAyah: 56  },
  { number: 21, nameAr: 'اتل ما أوحي',            nameEn: 'Utlu Ma Uhiya',           startSurah: 29, startAyah: 45  },
  { number: 22, nameAr: 'ومن يقنت',              nameEn: 'Wa Man Yaqnut',           startSurah: 33, startAyah: 31  },
  { number: 23, nameAr: 'وما لي',                nameEn: 'Wa Mali',                 startSurah: 36, startAyah: 28  },
  { number: 24, nameAr: 'فمن أظلم',              nameEn: 'Fa Man Azlam',            startSurah: 39, startAyah: 32  },
  { number: 25, nameAr: 'إليه يرد علم الساعة',    nameEn: 'Ilayhi Yuradu Ilm al-Saa', startSurah: 41, startAyah: 47 },
  { number: 26, nameAr: 'حم',                    nameEn: 'Ha Meem',                 startSurah: 46, startAyah: 1   },
  { number: 27, nameAr: 'قال فما خطبكم',          nameEn: 'Qala Fa Ma Khatbukum',   startSurah: 51, startAyah: 31  },
  { number: 28, nameAr: 'قد سمع',               nameEn: 'Qad Samia',               startSurah: 58, startAyah: 1   },
  { number: 29, nameAr: 'تبارك الذي',            nameEn: 'Tabaraka alladhi',        startSurah: 67, startAyah: 1   },
...
// Keep JUZ_DATA as alias for backwards compatibility
