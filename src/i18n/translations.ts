...
export const STRINGS = {
  ...
  naflPrayers: { ar: 'الصلوات النافلة', en: 'Voluntary Prayers' },
  ...
  notifPrayerLabel: { ar: 'إشعار وقت الصلاة', en: 'Prayer time alert' },
  notifReadingLabel: { ar: 'تذكير قراءة صفحة يوميًا', en: 'Daily Qur’an reading' },
  notifTahlilLabel: { ar: 'تذكير التهليل صباحًا', en: 'Morning remembrance' },
  notifGratitudeLabel: { ar: 'تذكير الشكر', en: 'Gratitude reminder' },
  athanModeLabel: { ar: 'نمط تنبيه الصلاة', en: 'Prayer alert style' },
  athanModeAthan: { ar: 'أذان', en: 'Athan' },
